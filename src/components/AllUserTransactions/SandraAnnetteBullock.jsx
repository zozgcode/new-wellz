...
import { SandraAnnetteBullockTxData } from "./tXdata";

export default function SandraAnnetteBullock() {
  return (
    <div className={style.transaction_history}>
      <div className={style.in_transaction_history}>
        ...
        {SandraAnnetteBullockTxData.length === 0 && (
          <div className={style.no_transaction_yet}>
            No transaction yet
          </div>
        )}
        {SandraAnnetteBullockTxData.map((aTxData, i) => (
