...
import { EduardMartirosyanTxData } from "./tXdata";

export default function EduardMartirosyan() {
  return (
    <div className={style.transaction_history}>
      <div className={style.in_transaction_history}>
        ...
        {EduardMartirosyanTxData.length === 0 && (
          <div className={style.no_transaction_yet}>
            No transaction yet
          </div>
        )}
        {EduardMartirosyanTxData.map((aTxData, i) => (
